        ...
        >
          ...
          <div className="relative -mt-16 sm:-mt-20 mx-4 bg-white rounded-2xl p-4 sm:p-5 shadow-lg">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-2">
              <button
                className="flex-1 bg-[#FF8906] text-[#0B132A] font-medium text-sm sm:text-base p-2 sm:p-2.5 rounded-lg hover:bg-orange-600 transition-colors duration-200"
                onClick={(e) => {
                  e.stopPropagation();
                  handleClick(item.id);
                }}
              ...
              <button
                className="border border-orange-500 p-2 sm:p-2.5 rounded-lg hover:bg-orange-50 transition-colors duration-200"
